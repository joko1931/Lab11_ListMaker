...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            {
                case "A":
                    userInput = SafeInput.getNonZeroLenString(in, "Please enter the item you want to add to the list");
                ...
                case "D":
                    if (myArrList.size() > 0)
                    {
                        deleteNum = SafeInput.getRangedInt(in, "Enter the item number that you wish to delete: ", 1, myArrList.size());
                ...
                case "Q":
                    ...
                    quitList = SafeInput.getYesNoInput(in, "\nAre you sure you want to quit?");
                    if (quitList)
                    {
                        System.exit(0);
                    }
